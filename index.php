		...
		<div id="page-wrapper">
						...
						<ul>
							...
							<li>
								...
								<ul>
									...
									<li><a href="./services.html#training">Cabin Crew</a></li>
									<li><a href="./services.html#training">Ground Handeling</a></li>
									<li><a href="./services.html#training">Airlines CSA</a></li>
									<li><a href="./services.html#training">Retail</a></li>
			...
			<!-- Banner -->
				<section id="banner">
					<div class="content" >
						<header>
							<h1 style="font-size:3em; text-align:left;">Get a Job</h1>
							<div class='console-container' style="text-align:left;"><span id='text'></span><div class='console-underscore' id='console'>&#95;</div></div>
						</header>
						<span class="image" ><img  src="images/pic01.jpg" alt="" /></span>
					</div>
					<!-- <div class="btnt desktop-only" id="fullscreen-button">
						...
						<div class="container">
							<div class="row">
								<div class="4u 12u$(medium)">
									<header>
										<h2>About Us</h2>
										<p>We Provide Services For Job Seekers</p>
									</header>
								</div>
								<div class="4u 12u$(medium)">
...
career opportunities in the aviation sector</p>
								</div>
								<div class="4u$ 12u$(medium)">
									<p>of Airlines and Airport Industry. Like - Air India Sats, Jet Airways, GoAir, Spice Jet, Indigo, Cambata, WHSmith etc. We are well-known for 100% placement and jobs recruitment to our
candidates as per their requirements and qualification in Airport/Airlines/Hospitality/Travels &amp; Tourism. <a href="./aboutus.html">See More</a></p>
								</div>
							</div>
						</div>
					</div>
					<a href="#oneafter" class="goto-next scrolly">Next</a>
				</section>
<!--one after-->

				<section id="oneafter" class="wrapper style1 special fade-up">
				...
				<!--mobile-->	
						...
						<div class="box alt mobile-only">
							<div class="row uniform">
								...
								<section class="4u 4u$(medium) 12u$(xsmall)">
									<span class="icon alt major fa-plane"></span>
									<h3>Cabin Crew Services</h3>
									
								</section>
								<section class="4u$ 4u(medium) 12u$(xsmall)">
									<span class="icon alt major fa-road"></span>
									<h3>Ground Handeling </h3>
									
								</section>
								<section class="4u$ 4u(medium) 12u$(xsmall)">
									<span class="icon alt major fa-file"></span>
									<h3>Airlines CSA Services</h3>
  ...
  <div class="slide_viewer">
    <div class="slide_group">
      <div class="slide">
	  <div style="position:absolute;bottom:26%; right:20% ">
		
		<a href="#" class="button special">Go there</a>
	  </div>
      </div>
	  <div class="slide">
  ...
  <div class="directional_nav desktop-only">
	...
	<br>
			...
			<!-- Two -->
				<section id="two" class="spotlight style2 right" >
					...
					<div class="content">
						...
						<p>
								<iframe width="100%" height="190px" src="https://www.youtube.com/embed/gZKQGdXfKp8" frameborder="0" allowfullscreen></iframe>
							</p>.
						<ul class="actions">
			...
			<!-- Three -->
				<section id="three" class="spotlight style3 left">
					...
					<div class="content">
						...
						<p>Arati Aviation is a growing team, and we looking forward to having energetic and aspiring candidates. We will update the section for latest job openings. Join the army of awesomes. </p>
						<ul class="actions">
							<li><a href="#" class="button">View More</a></li>
						</ul>
					</div>
					<a href="#cd-google-map" class="goto-next scrolly">Next</a>
				</section>
			...
			<!-- Four -->
				...
				<section id="cd-google-map">
							...
							<p style="width:100%; text-align:center">Keep touch with us</p>
						
	<div id="google-container"></div>
	<div id="cd-zoom-in"></div>
	<div id="cd-zoom-out"></div>
	<address>23 No. Boishnobpara Cross Road, West Bengal, India</address> 
	<footer class="major">
...
<script src="https://maps.googleapis.com/maps/api/js"></script>
 ...
 consoleText(['Welcome', 'Spread your wings', 'And fly with us', 'Join aviation industries'], 'text',['tomato','rebeccapurple','lightblue','tomato']);
